public class LeetCode_37_Sudukosolver {    
    char[][] board;
    int max = 9;
    ...
    private boolean isPresentincol(int column, char value){
    ...
    private boolean isCorrectToPlace(int row, int column, char value){
        return !isPresentinrow(row,value) && !isPresentincol(column,value) && !isPresentingrid(row,column,value);         
    }
